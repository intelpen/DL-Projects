...
def compute_content_cost(a_C, a_G):
    ...
    J_content =(1.0/(n_H* n_W* n_C*4 ))* tf.reduce_sum(tf.square(tf.subtract(a_C,a_G)))
    ### END CODE HERE ###
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = (1.0/(n_H* n_W* n_C*n_H* n_W* n_C*4 ))* tf.reduce_sum(tf.square(tf.subtract(GS,GG)))
